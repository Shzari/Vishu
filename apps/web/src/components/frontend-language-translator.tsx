...
const textTranslations = new Map<string, string>([
  ...
  ["Earnings", "Fitimet"],
  ["Settings", "Cilësimet"],
  ["Vendor workspace", "Hapësira e biznesit"],
  ["Vendor workspace", "Hapësira e biznesit"],
  ["Notifications", "Njoftime"],
  ["Vendor Panel", "Paneli i biznesit"],
  ["Product", "Produkti"],
  ...
  ["Vendor Security", "Siguria e biznesit"],
  ...
  ["Seller dashboard", "Paneli i biznesit"],
  ...
  ["Failed to load vendor workspace.", "Hapësira e biznesit nuk mund të ngarkohej."],
  ...
  ["Total vendor earnings", "Fitimet totale të biznesit"],
  ...
  ["Only a Shop Holder or Manager can manage vendor settings.", "Vetëm mbajtësi i dyqanit ose menaxheri mund të menaxhojë cilësimet e biznesit."],
  ...
  ["Vendor Settings", "Cilësimet e biznesit"],
  ["Your Shop", "Dyqani juaj"],
  ["Your Shop Settings", "Cilësimet e dyqanit tuaj"],
  ["Manage vendor profile and shop settings.", "Menaxho profilin e biznesit dhe cilësimet e dyqanit."],
  ["Sign out", "Dil"],
  ...
  ["Choose vendor or shopping mode", "Zgjidh modalitetin e biznesit ose blerjes"],
  ...
  ["Your cancellation request is waiting for the vendor. The order stays active until they cancel it or continue fulfillment.", "Kërkesa juaj për anulim është në pritje të biznesit. Porosia mbetet aktive derisa biznesi ta anulojë ose ta vazhdojë përmbushjen."],
  ["The vendor confirmed this order. You can still request cancellation until it is delivered.", "Biznesi e konfirmoi këtë porosi. Mund të kërkoni anulim derisa porosia të dorëzohet."],
  ...
  ["Manage shop information, working hours, low-stock alerts, and seller account configuration.", "Menaxhoni informacionin e dyqanit, orarin e punës, alarmet e stokut të ulët dhe konfigurimin e llogarisë së biznesit."],
  ...
  ["Vendor profile updated. Verify your new email before your next sign in.", "Profili i biznesit u përditësua. Verifikoni emailin e ri para hyrjes së radhës."],
  ["Vendor profile updated.", "Profili i biznesit u përditësua."],
  ["Failed to update vendor profile.", "Profili i biznesit nuk mund të përditësohej."],
  ...
  ["Vendor logo preview", "Parapamje e logos së biznesit"],
  ["Vendor cover preview", "Parapamje e kopertinës së biznesit"],
  ...
  ["Customers can place orders, vendors can manage their products, and admins can approve shops and oversee the whole platform.", "Klientët mund të bëjnë porosi, bizneset mund të menaxhojnë produktet e tyre dhe administratorët mund të miratojnë dyqanet dhe të mbikëqyrin të gjithë platformën."],
  ...
  ["Join as", "Bashkohu si"],
  ["Business registration", "Regjistrim biznesi"],
  ["Create a business account, verify your email, then sign in to add products and manage your shop.", "Krijoni llogari biznesi, verifikoni emailin, pastaj hyni për të shtuar produkte dhe për të menaxhuar dyqanin."],
  ["About Vishu", "Rreth Vishu"],
  ["About Vishu for businesses", "Rreth Vishu për biznese"],
  ["One marketplace workspace for local fashion businesses.", "Një hapësirë marketplace për bizneset lokale të modës."],
  ["Vishu helps shops prepare a professional online catalog, manage photos, stock, orders, and customer requests from one focused business panel.", "Vishu u ndihmon dyqaneve të përgatisin katalog profesional online, të menaxhojnë foto, stok, porosi dhe kërkesa të klientëve nga një panel biznesi."],
  ["Professional catalog", "Katalog profesional"],
  ["Add products with clean photos, sizes, colors, stock, and prices.", "Shtoni produkte me foto të qarta, madhësi, ngjyra, stok dhe çmime."],
  ["Review before launch", "Kontroll para publikimit"],
  ["Products stay hidden until they are checked and approved.", "Produktet qëndrojnë të fshehura derisa të kontrollohen dhe aprovohen."],
  ["Clear order tools", "Mjete të qarta për porosi"],
  ["Manage orders, delivery status, and business activity in one place.", "Menaxhoni porositë, statusin e dorëzimit dhe aktivitetin e biznesit në një vend."],
  ...
  ["Vendors must accept Vishu terms, marketplace policy, and refund policy.", "Bizneset duhet të pranojnë kushtet e Vishu, politikën e tregut dhe politikën e rimbursimit."],
  ...
  ["Update your seller account, shop information, branding, policies, and operating details in one place.", "Përditësoni llogarinë e biznesit, informacionin e dyqanit, markën, politikat dhe detajet operative në një vend."],
  ...
  ["Vendors no longer need to choose this manually. It is handled from the category setup in the background.", "Bizneset nuk kanë më nevojë ta zgjedhin manualisht. Kjo menaxhohet nga konfigurimi i kategorisë në sfond."],
