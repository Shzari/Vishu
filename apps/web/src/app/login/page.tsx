...
const loginCopy = {
  en: {
    ...
    merchantPriceValue: "Percentage-based fee",
    merchantPriceBody: "Vishu applies a percentage-based platform fee for each order.",
  ...
  sq: {
    ...
    merchantPriceValue: "Tarifë me përqindje",
    merchantPriceBody: "Vishu aplikon tarifë të platformës me përqindje për çdo porosi.",
